  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarDefaultTheme(
          context: context, isReverse: true, title: S.of(context).AddNewAddress),
       body:
                     ...
                     Container(
                       ...
                       TextFormField(
                         ...
                         decoration: InputDecoration(
                           labelText: S.of(context).TellUsDetails,
                 ...
                 Row(
                   children: [
                       ...
                       child: MaterialButton(
                         onPressed: ()
                         {
                           print("print");
                            ...
                            {
                              print("validate");
                              if(selectedRegion.isNotEmpty || selectedCity.isNotEmpty ) {
                                print("not empty");

                                print(other_phone_number.text);
                                print(message.text);
                               // print(AppCubit.get(context).idReg!.toInt());
                                print(fullName.text);
                                ...
                                navigateFinish(context, const AllAddresses());

                              }

                              else {return showToast(text: 'من فضلك ادخل المنطقة والمدينة والحي ان وجد', state: ToastStates.warning); }
                            }
                         },
                     ...
                     Expanded(
                       child: MaterialButton(
                        onPressed: (){
                          Navigator.pushReplacement(context, SliderLeft(page: const AllAddresses(), ));
